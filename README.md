...
## Acknowledgement
Evaluation code is adapted from [MMMU](https://github.com/MMMU-Benchmark/MMMU). We thank the original authors for sharing their implementation.
